...
$testResults += Test-Operation -Tool "earth_engine_data" -Operation "search" -Args @{
    operation = "search"
    query = "Sentinel-2"
    limit = 5
...
$testResults += Test-Operation -Tool "earth_engine_data" -Operation "info" -Args @{
    operation = "info"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
} -Description "Get dataset info (optimized)"

# Test 3: Get geometry
$testResults += Test-Operation -Tool "earth_engine_data" -Operation "geometry" -Args @{
    operation = "geometry"
...
$testResults += Test-Operation -Tool "earth_engine_data" -Operation "filter" -Args @{
    operation = "filter"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
...
$testResults += Test-Operation -Tool "earth_engine_data" -Operation "boundaries" -Args @{
...
$testResults += Test-Operation -Tool "earth_engine_process" -Operation "index" -Args @{
    operation = "index"
    indexType = "NDVI"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
...
$testResults += Test-Operation -Tool "earth_engine_process" -Operation "mask" -Args @{
    operation = "mask"
    maskType = "clouds"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
    startDate = "2024-06-01"
...
$testResults += Test-Operation -Tool "earth_engine_process" -Operation "composite" -Args @{
    operation = "composite"
...
$testResults += Test-Operation -Tool "earth_engine_process" -Operation "analyze" -Args @{
    operation = "analyze"
...
$testResults += Test-Operation -Tool "earth_engine_process" -Operation "terrain" -Args @{
    operation = "terrain"
    terrainType = "slope"
...
$testResults += Test-Operation -Tool "earth_engine_export" -Operation "thumbnail" -Args @{
    operation = "thumbnail"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
    startDate = "2024-06-01"
    endDate = "2024-06-30"
...
$testResults += Test-Operation -Tool "earth_engine_export" -Operation "tiles" -Args @{
    operation = "tiles"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
    startDate = "2024-06-01"
    endDate = "2024-06-30"
...
$testResults += Test-Operation -Tool "earth_engine_export" -Operation "export" -Args @{
    operation = "export"
    datasetId = "COPERNICUS/S2_SR_HARMONIZED"
    startDate = "2024-06-01"
    endDate = "2024-06-15"
    destination = "gcs"
    fileNamePrefix = "test_export_$((Get-Date).ToString('yyyyMMdd_HHmmss'))"
    scale = 30
    geometry = @{
        type = "Point"
        coordinates = @(-122.4194, 37.7749)
...
$testResults += Test-Operation -Tool "earth_engine_export" -Operation "status" -Args @{
    operation = "status"
...
$testResults += Test-Operation -Tool "earth_engine_system" -Operation "auth" -Args @{
    operation = "auth"
    checkType = "status"
} -Description "Check authentication status"

# Test 18: Get system info
$testResults += Test-Operation -Tool "earth_engine_system" -Operation "info" -Args @{
    operation = "info"
    infoType = "system"
...
$testResults += Test-Operation -Tool "earth_engine_system" -Operation "execute" -Args @{
    operation = "execute"
...
if ($successRate -eq 100) {
    ...
    Write-Host "  [WARN] NEEDS MORE WORK ($successRate%)" -ForegroundColor Yellow
