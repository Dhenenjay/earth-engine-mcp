...
Test-Operation -ToolName "earth_engine_data" -Operation "search" -Parameters @{
    query = "Sentinel-2"
    maxResults = 3
}

# Test 2: earth_engine_data - info
Test-Operation -ToolName "earth_engine_data" -Operation "info" -Parameters @{
    assetId = "COPERNICUS/S2_SR"
}

# Test 3: earth_engine_data - geometry
Test-Operation -ToolName "earth_engine_data" -Operation "geometry" -Parameters @{
...
Test-Operation -ToolName "earth_engine_system" -Operation "auth" -Parameters @{}

# Test 6: earth_engine_system - setup
Test-Operation -ToolName "earth_engine_system" -Operation "setup" -Parameters @{
    bucket = "test-ee-bucket"
    projectId = "test-project"
}

# Test 7: earth_engine_system - help
Test-Operation -ToolName "earth_engine_system" -Operation "help" -Parameters @{}

# Test 8: earth_engine_process - ndvi
Write-Host "=== Testing earth_engine_process Tool ===" -ForegroundColor Yellow
Test-Operation -ToolName "earth_engine_process" -Operation "ndvi" -Parameters @{
...
Test-Operation -ToolName "earth_engine_process" -Operation "ndwi" -Parameters @{
    datasetId = "COPERNICUS/S2_SR"
    startDate = "2024-01-01"
    endDate = "2024-01-31"
    geometry = @{
...
Test-Operation -ToolName "earth_engine_process" -Operation "thumbnail" -Parameters @{
    datasetId = "COPERNICUS/S2_SR"
    startDate = "2024-01-01"
    endDate = "2024-01-31"
    geometry = @{
...
Test-Operation -ToolName "earth_engine_process" -Operation "timeseries" -Parameters @{
    datasetId = "COPERNICUS/S2_SR"
    startDate = "2024-01-01"
    endDate = "2024-01-31"
    geometry = @{
...
Test-Operation -ToolName "earth_engine_export" -Operation "toAsset" -Parameters @{
...
Test-Operation -ToolName "earth_engine_export" -Operation "toDrive" -Parameters @{
    imageId = "COPERNICUS/S2_SR/20240115T183919_20240115T184201_T10SEG"
...
Test-Operation -ToolName "earth_engine_export" -Operation "toGCS" -Parameters @{
    imageId = "COPERNICUS/S2_SR/20240115T183919_20240115T184201_T10SEG"
    bucket = "test-ee-bucket"
